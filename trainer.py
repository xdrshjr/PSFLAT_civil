...
from cival_wospert.opt import tensorboardX
...
class BaseTrainer:
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self._save_path_bert_block = 'E:\\NLP\\NER_RE\\spert-master\\scripts\\data\\save\\rules_datasets_train\\tempDir\\final_bert_model'
    ...
    def _save_model_bert_block(self, save_path: str, model: PreTrainedModel, tokenizer: PreTrainedTokenizer,
                    iteration: int, optimizer: Optimizer = None, save_as_best: bool = False,
                    extra: dict = None, include_iteration: int = True, name: str = 'model'):
        extra_state = dict(iteration=iteration)
