...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_path', type=str, default="E:\\NLP\\bertTraining\\a_journey_into_math_of_ml-master\\04_transformer_tutorial_2nd_part\\BERT_tutorial\\chinese_L-12_H-768_A-12\\", help="Path to directory that contains model checkpoints")
    arg_parser.add_argument('--model_type', type=str, default="cival_wospert", help="Type of model")
