...
class Rules_DataSets_NERLoader(Loader):
    ...
    def load(self, newJson) -> DataBundle:
        print(newJson)
        # datasets = {'data': self._load(path) for path in paths}
        data_bundle = DataBundle(datasets=newJson)
        return data_bundle
